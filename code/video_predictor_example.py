...
Original file is located at
    https://colab.research.google.com/github/facebookresearch/segment-anything-2/blob/main/notebooks/video_predictor_example.ipynb
"""
...
If running locally using jupyter, first install `sam3` in your environment using the [installation instructions](https://github.com/facebookresearch/segment-anything-2#installation) in the repository.
...
if using_colab:
    ...
    #
    # !mkdir - p.. / checkpoints /
    # !wget - P.. / checkpoints / https: // dl.fbaipublicfiles.com / segment_anything_2 / 072
    # 824 / sam2_hiera_large.pt
...
for out_frame_idx in range(0, len(frame_names), vis_frame_stride):
    ...
    current_frame = Image.open(os.path.join(video_dir, frame_names[out_frame_idx]))
    ...
    plt.tight_layout()
    plt.gca().set_position([0, 0, 1, 1])  # Set figure position to remove padding
    ...
    rendered_frame_path = os.path.join(rendered_dir, f"rendered_frame_{out_frame_idx:05d}.png")
    cv2.imwrite(rendered_frame_path, image_array)
...
#     rendered_frame_path = os.path.join(rendered_dir, f"rendered_frame_{out_frame_idx:05d}.png")
#     plt.savefig(rendered_frame_path)
#     plt.close()  # Close the figure to save memory
