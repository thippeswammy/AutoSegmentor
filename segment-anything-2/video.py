...
# Print PyTorch and torchvision versions and CUDA availability
...
# zip_file_path = 'videos/bedroom.zip'
...
# Render the segmentation results every few frames and save them
vis_frame_stride = 30
plt.close("all")
